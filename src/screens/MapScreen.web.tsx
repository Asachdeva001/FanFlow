...
const MapView: any = ({ children, style }: any) => (
  <View style={[style, { backgroundColor: '#212121', justifyContent: 'center', alignItems: 'center' }]}>
    <Text style={{ color: '#00D1FF', fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>Interactive Map</Text>
    <Text style={{ color: '#757575', fontSize: 16, textAlign: 'center', paddingHorizontal: 20 }}>The 3D Map and AR features are optimized for the native mobile app.</Text>
  </View>
);
const Marker: any = () => null;
const Polyline: any = () => null;
const Heatmap: any = () => null;
